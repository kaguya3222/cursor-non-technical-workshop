...
function App() {
  ...
  // Load recipes from browser storage when app starts
  ...
  // Save recipes to browser storage whenever they change
  useEffect(() => {
                ...
                <div className={styles.recipeImage}>
                  {recipe.image ? (
                    <img
                      src={recipe.image}
                      alt={recipe.title}
                      className={styles.recipeImageImg}
                    />
                  ) : (
